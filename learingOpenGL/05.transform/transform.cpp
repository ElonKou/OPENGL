...
int main()
{
    ...
    Shader sh("./vertex.glsl", "./frag.glsl");
    ...
    int width, height;
    unsigned char *image = SOIL_load_image("mmmm.jpg", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        GLint transformLoc = glGetUniformLocation(sh.Program, "transform");
